...
function InfoGrid() {
  ...
  return (
    ...
    <div className='grid lg:grid-cols-3 lg:grid-rows-[repeat(8,_minmax(0,_1fr))] gap-4 min-h-full'>
      ...
      <div className='relative col-start-1 lg:col-span-1 row-span-4 w-full px-4 py-6  bg-neutral-900 lg:rounded-lg border border-slate-400 hover:border-orange-600 flex align-start justify-between pl-6'>
      ...
      <div className="col-start-2 row-start-2 row-span-2 relative lg:col-span-1 transition duration-75 ease-in-out bg-neutral-900 rounded-lg border border-zinc-600 hover:border-orange-600 px-6 py-6 overflow-hidden">
  ...
  <p className="relative z-10 italic">Currently pursuing Bachelors in Technology</p>
    ...
    <div className={`col-start-2 text-red-600 relative lg:col-span-1 row-start-4 row-span-1 text-2xl font-semibold transition duration-75 ease-in-out lg:rounded-lg border border-slate-400 hover:border-orange-600 flex items-center justify-center font-cinzel`}>
            Good Anime
            <div className="absolute inset-0 z-0 opacity-20 overflow-hidden">
      ...
      <div className='col-start-3 row-span-1 row-start-1 w-full relative px-4 py-6  bg-neutral-900 lg:rounded-lg border border-slate-400 hover:border-orange-600 flex align-start justify-between transform perspective-1200 transition duration-75 ease-in-out lg:col-span-1 lg:row-span-1 font-cinzel'>
          <div className="absolute inset-0 z-0 opacity-20 overflow-hidden">
