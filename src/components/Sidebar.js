...
function Sidebar() {
  ...
  return (
    <>
      ...
      <motion.div drag dragConstraints={{top:0,left:0,right:0,bottom:0}} className='lg:col-start-4 overflow-hidden row-span-3 relative h-full font-mono text-xs rounded-lg px-2 pt-6 pb-4 lg:row-span-3 bg-zinc-950 border border-zinc-800 shadow-inner'>
        {/* Header */}
        ...
        <div className='flex items-center gap-1 mt-4'>
          ...
          />
          <button onClick={handleSend} className='bg-zinc-900 border border-zinc-700 hover:bg-zinc-800 text-white px-3 py-[2px] rounded-md'>
            Shout
          </button>
        </div>
